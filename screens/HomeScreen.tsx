...
function CircularProgress({ percent }: { percent: number }) {
  ...
  return (
    <View style={{ width: size, height: size, justifyContent: "center", alignItems: "center" }}>
      ...
      <Text style={{ color: "#FFF", fontWeight: "bold", fontSize: 16 }}>{`${percent}%`}</Text>
    </View>
  );
}
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollArea} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.banner}>
            <View style={{ flex: 1 }}>
              ...
              <TouchableOpacity style={styles.bannerBtn} onPress={() => navigation.navigate("Calendar")}>
          ...
          >
            ...
            <View style={[styles.cardH, { backgroundColor: "#FFEDD5" }]}>
              ...
              <View style={styles.pBar}>
                <View style={[styles.pFill, { width: "30%", backgroundColor: "#F97316" }]} />
              </View>
            </View>
          </ScrollView>
...
const styles = StyleSheet.create({
  ...
  banner: { backgroundColor: "#5F33E1", borderRadius: 30, padding: 25, flexDirection: "row", alignItems: "center", marginBottom: 35 },
  ...
  eventItem: { flexDirection: "row", alignItems: "center", backgroundColor: "#FFF", padding: 18, borderRadius: 20, marginBottom: 15, elevation: 2, shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 2 },
