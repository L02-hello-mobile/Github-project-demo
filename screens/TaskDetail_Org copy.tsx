...
const taskOptions = [
  { key: "logistics", label: "Nhóm logistics" },
  { key: "technical", label: "Nhóm kỹ thuật" },
  { key: "media", label: "Nhóm media" },
  { key: "security", label: "Nhóm an ninh" },
  { key: "support", label: "Nhóm hỗ trợ" },
  { key: "management", label: "Nhóm quản lý" },
];
...
export default function TaskDetailScreen({ route }: { route?: any }) {
  ...
  const [group, setGroup] = useState(
    getGroupKeyFromLabel(taskData?.group || taskData?.category),
  );
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      {openDropdown && (
        ...
        <View style={styles.cardRowBtn}>
          ...
          <TouchableOpacity style={styles.innerButton} onPress={() => navigation.navigate("Members") }>
